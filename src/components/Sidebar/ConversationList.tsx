    ...
    <>
      {conversationList.map((conversation) => (
        ...
        >
          ...
          <Dropdown
            tigger={
              <button className="flex items-center justify-center invisible w-4 h-4 text-gray-400 shrink-0 group-hover:visible hover:text-gray-500">
      ...
      <button
        className="flex flex-row items-center justify-center w-full px-4 py-3 my-4 text-gray-500 border rounded-lg dark:border-zinc-800 dark:text-gray-400 hover:text-gray-700 hover:bg-gray-50 dark:hover:bg-zinc-800"
