...
const ConversationView = () => {
  ...
  return (
    ...
    >
      <div className="sticky top-0 flex flex-col items-start justify-start w-full bg-white z-1 dark:bg-zinc-800">
      ...
      <div className="sticky bottom-0 flex flex-row items-center justify-center w-full max-w-4xl px-4 py-2 pb-4 mx-auto bg-white sm:px-8 dark:bg-zinc-800 bg-opacity-80 backdrop-blur">
        <ClearConversationButton />
        <MessageTextarea disabled={lastMessage?.status === "LOADING"} sendMessage={sendMessageToCurrentConversation} />
        <div className="relative flex flex-row items-center justify-end mr-2" onClick={() => setShowSchemaDrawer(true)}>
          {
