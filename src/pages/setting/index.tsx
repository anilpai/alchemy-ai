...
import { ArrowUturnLeftIcon, Bars3Icon, Cog6ToothIcon, XMarkIcon } from "@heroicons/react/24/outline";
    ...
    <>
      ...
      <div className="dark:bg-zinc-800">
            ...
            <div className="fixed inset-0 flex">
              ...
              >
                <Dialog.Panel className="relative flex flex-1 w-full max-w-xs mr-16">
                  ...
                  <div className="flex flex-col px-6 pb-2 overflow-y-auto bg-white grow gap-y-5 dark:bg-zinc-800">
        ...
        <div className="hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-72 lg:flex-col">
          {/* Sidebar component, swap this element with another sidebar if you like */}
          <div className="flex flex-col px-6 overflow-y-auto bg-white border-r border-gray-200 grow gap-y-5 dark:border-zinc-700 dark:bg-zinc-700">
            <nav className="flex flex-col flex-1">
              <ul role="list" className="flex flex-col flex-1 gap-y-7">
                <li>
                  <ul role="list" className="-mx-2 space-y-1">
        ...
        <div className="sticky top-0 z-40 flex items-center px-4 py-4 bg-white shadow-sm gap-x-6 dark:bg-zinc-700 sm:px-6 lg:hidden">
